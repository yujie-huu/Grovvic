    ...
    parts.forEach((part, index) => {
      ...
      if (index === 0 && formattedPart.includes('Botanical name:')) {
        ...
        if (botanicalNameMatch) {
          const botanicalName = botanicalNameMatch[1].replace(/,$/, ''); // Remove the comma at the end
    ...
    <div className="plant-detail-page">
      <div className="plant-detail-content">
        ...
        <div className="notes-pollinator-container">
          ...
          {(plantData.notes || plantData.notes === "") && (
            <div className="pollinator-section">
              <h2 className="pollinator-title">POLLINATORS</h2>
        ...
        <div className="detailed-instructions-container">
          <h2 className="instruction-header">Step by Step Gardening</h2>

          <div className="instruction-card">
            <div className="instruction-card-header">
              <img className="instruction-icon" src="/images/instruction_preparation_icon.png" alt="Preparation"/>
          ...
          <div className="instruction-card-green">
            <div className="instruction-card-header" style={{gridTemplateRows: '6rem 1fr'}}>
              <img className="instruction-icon" style={{height: '6rem'}} src="/images/instruction_sow_icon.png" alt="Sow"/>
          ...
          <div className="instruction-card">
            <div className="instruction-card-header">
              <img className="instruction-icon" src="/images/instruction_grow_icon.png" alt="Grow"/>
